...
namespace TMPro
{
    public class RubyTextMeshProUGUI : TextMeshProUGUI
    {
        ...
        // ruby tag
        private static readonly Regex RubyRegex = new Regex(@"<r=([\s\S]*?)>([\s\S]*?)<\/r>");
        ...
        [SerializeField] private RubyShowType rubyShowType = RubyShowType.BASE_ALIGNMENT;
        [Tooltip("all v compensation ruby.")]
        [SerializeField] private bool allVCompensationRuby;
        [Tooltip("all ruby v compensation. (em, px, %).")]
        [SerializeField] private string allVCompensationRubyLineHeight = "2.5em";
        ...
        protected void SetTextCustom(string value)
        {
